export const countryCodes = [
  ...
  { country: 'Dominican Republic', code: '+1-809, 1-829, 1-849', iso: 'DO', flag: '🇩🇴' },
  ...
  { country: 'Northern Mariana Islands', code: '+1-670', iso: 'MP', flag: '🇲🇵' },
  ...
  { country: 'Saint Vincent and the Grenadines', code: '+1-784', iso: 'VC', flag: '🇻🇨' },
  ...
  { country: 'Turks and Caicos Islands', code: '+1-649', iso: 'TC', flag: '🇹🇨' },
