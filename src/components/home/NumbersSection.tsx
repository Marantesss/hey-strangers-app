  ...
  return (
    <section className="container space-y-20 py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-8">
        {/* Cities */}
        <div className="bg-primary p-4 md:p-12 flex flex-col gap-6 justify-between md:justify-end text-white md:col-span-2 h-60 md:h-auto md:row-span-2">
          <p className="text-5xl font-bold">{numbers.numbers[0].value}</p>
          <p className="text-lg font-medium">{numbers.numbers[0].label}</p>
        </div>

        <div className="bg-[#F5F7F9] p-4 md:p-12 flex flex-col justify-between items-end md:col-span-3 rounded-bl-[16rem] h-60 md:h-auto md:aspect-square">
        ...
        <div className="bg-[#E3FFCD] p-4 md:p-12 flex flex-col justify-between items-end md:col-span-3 h-60 md:h-auto md:aspect-square rounded-l-[16rem]">
        ...
        <div className="bg-[#F5F7F9] p-4 md:p-12 flex flex-col justify-between items-start md:col-span-3 rounded-tr-[16rem] h-60 md:h-auto md:aspect-square">
        ...
        <div className="bg-primary p-4 md:p-12 flex flex-col justify-between items-start text-[#E3FFCD] md:col-span-3 h-60 md:h-auto md:aspect-square rounded-[1.5rem] md:rounded-[4rem]">
