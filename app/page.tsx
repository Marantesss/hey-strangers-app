    ...
    <main>
        ...
        <div className='min-h-screen container py-8 flex flex-col items-center justify-between gap-8'>
          ...
          <div className='text-center space-y-8'>
            ...
            <p className="max-w-lg">
              Play <WordCycle /> with friendly strangers—matched to your skills and preferences by AI.
            </p>
            ...
            <p className="max-w-lg">
              ...
              <span className="font-bold">
                1 day 9 hours 33 min 12 seconds
              </span>
            </p>
              ...
              return (
                <div key={game.id} className="relative h-80 rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute text-sm inset-0 bg-gradient-to-t from-black/80 to-transparent p-6 flex flex-col justify-end gap-2 text-white">
                    <h3>{game.sport}</h3>
                    <p className="font-bold">{gameDay} • {gameStartTime}</p>
      ...
      <section className="container space-y-20 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            { icon: '/how-icons/quiz.png', title: 'Take our quick 3-minute skills tests', description: 'Your skills help us find the right group for you. Don\'t worry—your data is 100% protected.' },
            { icon: '/how-icons/schedule.png', title: 'Choose your game and time', description: 'Browse pre-planned games with set locations and times—just pick what works best for you.' },
            { icon: '/how-icons/show-up.png', title: 'Show up and say hey strangers', description: 'We handle all the planning. Just show up, meet new friends, play your favorite sports, and enjoy the experience!' },
          ].map((item, index) => (
      ...
      <section className="container py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex flex-col gap-8">
            <h2 className="text-2xl font-bold">Facts facts about<br />Hey Strangers</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {
                [
                  { value: 95, label: 'of players', description: 'say they were perfectly matched with their group\'s skill level.' },
                  { value: 82, label: 'of participants', description: 'would recommend Hey Stranger to their friends.' },
                  { value: 78, label: 'of players', description: 'have made lasting connections through our sports activities.' },
                ].map((item, index) => (
        ...
        <div className="container space-y-20">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                {
                  quote: "Joining Hey Stranger has been a game-changer! I was nervous about meeting new people, but the matching process was spot on. Now, I have a regular group for soccer, and it's the highlight of my week!",
                  author: "Alex S.",
                  image: "/strangers/alex.jpg"
                },
                {
                  quote: "I love how easy it is to find games that fit my schedule. The platform takes all the hassle out of organizing, and I've met some amazing paddle buddies along the way!",
                  author: "Rita M.",
                  image: "/strangers/rita.jpg"
                },
                {
                  quote: "As someone new to the city, Hey Stranger made it so easy to connect with people who share my love for tennis. It's like having a ready-made community waiting for you.",
                  author: "Sara C.",
          ...
          <div className="bg-white rounded-2xl p-8 md:w-[600px]">
            ...
            <div className="flex items-center gap-2 text-sm mb-8">
              <span className="flex items-center gap-2">
                <span className="size-6 bg-secondary rounded-full text-white flex items-center justify-center">1</span>
                Sport
              </span>
              <span className="h-[2px] w-12 bg-gray-200 grow"></span>
              <span className="flex items-center gap-2">
                <span className="size-6 rounded-full bg-gray-100 text-gray-400 flex items-center justify-center">2</span>
                Frequency
              </span>
              <span className="h-[2px] w-12 bg-gray-200 grow"></span>
              <span className="flex items-center gap-2">
                <span className="size-6 rounded-full bg-gray-100 text-gray-400 flex items-center justify-center">3</span>
                Competitiveness
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <h3 className="font-semibold text-lg">Pre-scheduled games at convenient locations</h3>
              ...
              {[
                {
                  ...
                  answer: "Our AI-powered matching system considers your experience level, playing style, and preferences to connect you with players of similar skill levels. This ensures balanced, enjoyable games for everyone involved."
                },
                {
                  value: "item-2", 
                  question: "What happens if I need to cancel a game?",
                  answer: "You can cancel a game up to 24 hours before the scheduled time without any penalty. We'll notify other players and help find a replacement to ensure the game can still go ahead."
                },
                {
                  value: "item-3",
                  question: "Are the venues and equipment provided?", 
                  answer: "All venues are pre-booked and included in the game fee. For equipment, it varies by sport and venue - we'll clearly indicate what's provided and what you need to bring in the game details."
                },
                {
                  value: "item-4",
                  question: "How do I pay for games?",
                  answer: "Payment is handled securely through our platform. You can pay per game or opt for a membership plan if you play regularly. We accept all major credit cards and digital payment methods."
                },
                {
                  value: "item-5",
                  question: "Is there a minimum commitment required?",
                  answer: "No minimum commitment! You can join games as frequently or infrequently as you like. Some players join weekly regular games, while others play occasionally - it's entirely up to you."
                }
              ].map(item => (
                <AccordionItem key={item.value} value={item.value} className="border border-[#EBEBEB]">
                  <AccordionTrigger className="px-6 data-[state=open]:bg-[#F5F7F9] data-[state=open]:text-primary data-[state=open]:rounded-b-none">
                    {item.question}
                  </AccordionTrigger>
                  <AccordionContent className="bg-[#F5F7F9] px-6">
                    {item.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
      ...
      <section className='bg-primary py-20'>
        <div className="container gap-8 flex flex-col items-center">
          <h2 className="text-4xl font-bold text-[#E3FFCD]">Hey Stranger, ready to take a chance?</h2>
          <Button className="bg-[#E3FFCD] hover:bg-[#D1F7B0] border-0 text-primary font-semibold">
            Choose your game
          </Button>
        </div>
        ...
        <div className="container flex md:flex-row md:justify-between flex-col gap-8">
          <ul className="flex flex-wrap gap-6 justify-center">
            <li className="text-center">
              <a href="#" className="hover:text-[#E3FFCD] transition-colors">Contact Us</a>
            </li>
            <li className="text-center">
              <a href="#" className="hover:text-[#E3FFCD] transition-colors">Safety Tips & Rules</a>
            </li>
            <li className="text-center">
              <a href="#" className="hover:text-[#E3FFCD] transition-colors">Community Guidelines</a>
            </li>
            <li className="text-center">
              <a href="#" className="hover:text-[#E3FFCD] transition-colors">Terms & Conditions</a>
            </li>
            <li className="text-center">
              <a href="#" className="hover:text-[#E3FFCD] transition-colors">Privacy Policy</a>
            </li>
          </ul>
